...
function Bill() {
    ...
    const [result, setResult] = useState<{id:string; username:string; item:string; date:string; expiry:string; lot_size:string; no_of_lot:string; buy_qty:string; buy_price:string; buy_net_price:string; sell_qty:string; sell_price:string; sell_net_price:string; pnl:string; net_qty:string; cmp:string; mtm:string;net:string;}[]>([]);
        ...
        <div className="bill-container">
            ...
            <div className="search-container">
                <form onSubmit={submitform}>
                    ...
                    <button className="search-button" type="submit">Generate BILL</button>
                </form>
                <div>
                    <h1>Details</h1>
                    <Button onClick={exportToExcel} variant="ghost">Export to Excel</Button>
                </div>
